...
console.log(Number.parseInt('50', 10));
console.log(Number.parseInt('50.5'));
console.log(Number.parseInt('50.5px'));
console.log(Number.parseFloat('50'));
console.log(Number.parseFloat('50.5'));
console.log(Number.parseFloat('50.5px'));

console.log(Number.isFinite(+'23'));
console.log(Math.sqrt(25));
console.log(25 ** (1 / 2));
console.log(8 ** (1 / 3));
console.log(8000 ** (1 / 3));
console.log(Math.max(5, 18, 20, 25, 1, 7, 26));
console.log(Math.max(5, 18, 20, 25, 1, 7, '26px'));
...
// const now = new Date();
// console.log(now);
// console.log(new Date('Sun Oct 16 2022 01:56:19'));
...
// console.log(2142249780000 / 365 / 24 / 60 / 60 / 1000);
// console.log(1970 + 67);
...
setTimeout(
  (ing1, ing2) => console.log(`Here your pizza with ${ing1} and ${ing2}`),
  3000,
  'olives',
  'spinach'
);
